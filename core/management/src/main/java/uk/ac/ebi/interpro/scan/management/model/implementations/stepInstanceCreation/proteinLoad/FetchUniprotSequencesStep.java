 ...
 * @since 1.0
 */
public class FetchUniprotSequencesStep extends Step implements StepInstanceCreatingStep {

    private static final Logger LOGGER = Logger.getLogger(FetchUniprotSequencesStep.class.getName());
